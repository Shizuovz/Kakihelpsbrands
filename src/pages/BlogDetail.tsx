  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 pt-24">
      ...
      <section className="pb-24 px-6 relative overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-96 h-96 bg-purple-100 blur-[120px] pointer-events-none" />
        <div className="absolute bottom-20 left-0 w-96 h-96 bg-blue-100 blur-[120px] pointer-events-none" />
